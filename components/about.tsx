...
export function About() {
  ...
  const defaultInfo = {
    ...
    skills: [{"icon":"code","title":"프론트엔드 개발 예정","description":"React, TypeScript, Next.js를 활용한 모던 웹 개발 예정"},{"icon":"database","title":"백엔드 개발 예정","description":"Node.js, Python, 데이터베이스 설계 및 구현 예정"},{"icon":"palette","title":"UI/UX 디자인 예정","description":"사용자 중심의 인터페이스 디자인 예정"}],
    storyTitle: "소개",
    ...
    storyImage: "/uploads/about-image-1758189015812.jpg",
    hobbies: ["📚 독서","☕ 카페 투어","🎨 전시회 관람","✈️ 여행","🎮 게임","✍️ 글쓰기","🎭 연극 관람","🎪 공연 관람","📸 사진","🎵 음악 감상","🎬 영화 감상"]
  }
