...
export function About() {
  ...
  const defaultInfo = {
    ...
    skills: [{"icon":"code","title":"프론트엔드 개발 예정","description":"React, TypeScript, Next.js를 활용한 모던 웹 개발"},{"icon":"database","title":"백엔드 개발 예정","description":"Node.js, Python, 데이터베이스 설계 및 구현"},{"icon":"palette","title":"UI/UX 디자인 예정","description":"사용자 중심의 인터페이스 디자인"},{"icon":"heart","title":"근면성실","description":"끝까지 맡은 바 일을 로봇처럼 실행합니다"}],
    storyTitle: "나의 이야기",
